...
riscv-none-elf-gcc -O2 -march=rv32imf -mabi=ilp32 -ffp-contract=off -ffreestanding -nostdlib -mcmodel=medany -Wl,--no-warn-rwx-segments -T link.ld start.S *.c -o program.elf
